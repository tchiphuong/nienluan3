            ...
            <div class="table-responsive">
                <table class="table table-striped b-t b-light">
                    ...
                    @foreach($all_brand_product as $key => $cate_pro)
                        ...
                        <span class="text-ellipsis">
                            @if($cate_pro->brand_status == 0)
                                <a href="{{URL::to('/show-brand-product/'.$cate_pro -> brand_id)}}"><i class="fa fa-eye-slash" style="color: red"></i></a>
                            @else
                                <a href="{{URL::to('/hide-brand-product/'.$cate_pro -> brand_id)}}"><i class="fa fa-eye" style="color: black"></i></a>
                            @endif
                        </span>
                            </td>

                            <td>
                                <a href="{{URL::to('/edit-brand-product/'.$cate_pro -> brand_id)}}" name="edit_brand_product" class="active" ui-toggle-class=""><i class="fa fa-pencil text-success text-active"></i></a>
                                <a href="{{URL::to('/delete-brand-product/'.$cate_pro -> brand_id)}}" name="dalete_brand_product" class="active" ui-toggle-class="" onclick="return confirm('Are you sure to delete?')"><i class="fa fa-trash text-danger text"></i></a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
